    ...
    <div className="app">
      <div className="top-bar">
        ...
        <div className="month-nav">
          <button className="nav-btn" onClick={() => navigateMonth(-1)} aria-label="Mês anterior">
            <i className="ti ti-chevron-left" aria-hidden="true" />
          </button>
          <button className="month-label" onClick={() => setMonthPickerOpen(true)}>
            {monthLabel}
          </button>
          <button className="nav-btn" onClick={() => navigateMonth(1)} aria-label="Próximo mês">
      ...
      <CategoryCharts transactions={enriched} />
